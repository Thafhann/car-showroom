...
<body class="hold-transition ">
  ...
  <style>
    ...
    body{
      background-image: url("../uploads/cars/admin-cover.jpg");
  ...
  <div class="h-100 d-flex align-items-center w-100" id="login">
    <div class="col-7 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100">
        <h1 class="text-center py-5 login-title"><b><?php echo "Rizki Showroom" ?> - Admin</b></h1>
        <center><img src="<?= validate_image($_settings->info('logo')) ?>" alt=""></center>
      </div>
      
    </div>
    <div class="col-5 h-100 bg-dark">
