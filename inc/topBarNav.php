...
<!-- Navbar -->
      ...
      <?php endif; ?>
      <nav class="main-header navbar navbar-dark bg-dark navbar-expand border border-light border-top-0  border-left-0 border-right-0 text-sm text-light" id='top-Nav'>
        ...
        <div class="container">
          <a href="./" class="navbar-brand">
            ...
            <span class="brand-text font-weight-light text-light"><?php echo "Rizki Showroom" ?></span>
          </a>
